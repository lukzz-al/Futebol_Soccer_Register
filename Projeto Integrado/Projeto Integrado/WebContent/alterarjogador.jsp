...
">Selecione o time</option>
						...
						<td id="espaço">Salario: R$</td>
						<td><input type="text" name="txtsalario" OnKeyPress="formatar('####.##', this)" maxlength="7"
							placeholder="Digite o salário" required="required" value="<%=jog.getTimes().getSalario() %>"></td>
